...
R and Python are both useful for undergraduate students to learn to advance their research projects and gain access to new career opportunities in today's competitive job market. Here we used a combination of open-source tutorials and resources to teach R to undergraduate students for a summer research project. Students worked collaboratively to build an interactive web application, the Organonitrogen Biodegradation Database (ONDB), using R Shiny and flexdashboard. In addition to providing code for the ONDB web application itself (see app.Rmd), we also provide a generalized [8-week tutorial](https://docs.google.com/document/d/1BfLigj1lufe_uFdIaf1sWpAtg1Aih9jnVFdYx_Xj1B8/edit?usp=sharing) as a teaching resource for others:
* [8-week tutorial in R](https://docs.google.com/document/d/1BfLigj1lufe_uFdIaf1sWpAtg1Aih9jnVFdYx_Xj1B8/edit?usp=sharing) - this tutorial is also included as appendix XI in the above publication.

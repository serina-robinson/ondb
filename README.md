...
The learning curve for R can be steep, but it is a highly useful skill for statistics and data mining. R and Python are some of the main languages for undergraduate students to gain new career opportunities in the job market. Here we used a combination of open-source tutorials and resources to teach R to undergraduate students for a summer research project. Students worked collaboratively to build an interactive web application, the Organonitrogen Biodegradation Database (ONDB), using R Shiny and flexdashboard. In addition to providing code for the ONDB web application itself (see app.Rmd), we also provide a generalized [8-week tutorial](https://github.com/serina-robinson/ondb/blob/main/tutorials/ONDB_SampleTutorials.pdf) as a teaching resource for others:
